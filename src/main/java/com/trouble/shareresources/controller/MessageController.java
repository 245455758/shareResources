...
public class MessageController {
    ...
    public ResultType sendValidateMessage(){
        ...
        try {
            ...
            e.printStackTrace();
            return new ResultType(false,"验证码发送失败");
        }

    }


    public void sendMessage(String code,String phoneNum) throws Exception {
...
//初始化ascClient,暂时不支持多region（请勿修改）
        ...
        //必填:短信签名-可在短信控制台中找到
        request.setSignName("MrBug学习测试版");
        //必填:短信模板-可在短信控制台中找到，发送国际/港澳台消息时，请使用国际/港澳台短信模版
        request.setTemplateCode("SMS_148611806");
